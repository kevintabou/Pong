...
class Ennemi:
    ...
    def __init__(self):
        ...
        self.couleurdujoueur = (255, 255, 255)
    ...
    def move(self):
        ...
        if self.rectangle.x > core.WINDOW_SIZE[0] - self.rayonducercle:
            ...
            self.couleurdujoueur = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
        ...
        if core.getMouseLeftClick() is not None:
            ...
            self.PS = pygame.Vector2(self.pos_souris.x - self.rectangle.x, self.pos_souris.y - self.rectangle.y)
